...
import { setView, setView2DModule } from "../../../../../redux/building/buildingSlice";
...
export default function Button2D() {
	...
	const handleViewModule = (module) => () => {
		dispatch(setView2DModule({ view2DModule: module }));
		handleClose();
	}
		...
		<>
			...
			>
				<Grid container spacing={.4} style={{ width: "280px" }}>
					...
					{/* AMBIENTES */}
				{/* <Grid> */}
					<Grid item xs={7} className="cursor" style={{marginLeft: "2.5rem"}}>
						<div className="module">
							MÓDULO AULA
						</div>
					</Grid>
