...
import TerrainView from "../../../Builder/components/TerrainView/TerrainView";
import InitConfig from "../../../Builder/Plan3D/components/InitConfig/InitConfig";
import Pabellones from "../../../Builder/Plan3D/components/Pabellones/Pabellones";
...
export default function View3D({ selectedVersion }) {
	...
	let aforoData = JSON.parse(selectedVersion.aforo);
