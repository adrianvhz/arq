...
>
	<Grid
		...
		// xl={9}
	>
		<div style={{backgroundImage: `url(${banner})`, backgroundSize: "cover", backgroundRepeat: "round", width: "100%", minHeight: "100%"}}>
	...
	<Grid
		...
		// xl={3}
	>
		<Grid item xs={12} bgcolor="#05245C" height={180}>
		</Grid>

		<Grid item xs={6} sx={{margin: "auto", marginTop: "-60px", marginBottom: "15px", bgcolor: "#fff", padding: "20px", height: "100px", minWidth: "300px", textAlign: "center", boxShadow: "0 0.5rem 1.5rem 0.5rem rgb(0 0 0 / 8%)" }} className="box-shadow">
			<h4>
				<b>PRO DESIGN</b>
					<br />
